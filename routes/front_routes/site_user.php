<?php
Route::post('show-comment-user', 'UserController@showComment')->name('show.comment.user');
Route::get('home-profile', 'CheckProfileController@fullProfile')->name('home.profile');
Route::put('update-my-profile', 'CheckProfileController@updateMyProfile')->name('update.my.profile');
Route::post('logout-user', 'UserController@logout')->name('logout.user');
/* * ******** UserController ************ */
...
Route::post('user-delete-user}', 'UserController@deleteUser')->name('user.delete.user');
Route::post('user-change-meeting', 'UserController@changeMeeting')->name('user.change.meeting');
/* * *********************************** */ 
