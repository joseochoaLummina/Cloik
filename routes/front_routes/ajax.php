...
Route::post('filter-states-dropdown', 'AjaxController@filterCities')->name('filter.states.dropdown');
Route::post('filter-degree-types-dropdown', 'AjaxController@filterDegreeTypes')->name('filter.degree.types.dropdown');

Route::post('show-recomendacion', 'AjaxController@showRecomendacion')->name('show.recomendacion');
