...
/* * ****** End LanguageLevel ********** */
// test de idioma
Route::get('get-language-test', array_merge(['uses' => 'Admin\LanguageLevelController@getLanguageTest'], $all_users))->name('get.language.test');
Route::post('post-new-language-test', array_merge(['uses' => 'Admin\LanguageLevelController@newLanguageTest'], $all_users))->name('post.new.test.language');
Route::put('update-language-test', array_merge(['uses' => 'Admin\LanguageLevelController@updateLanguageTest'], $all_users))->name('put.paragraphs');
Route::delete('delete-language-test', array_merge(['uses' => 'Admin\LanguageLevelController@deleteLanguageTest'], $all_users))->name('delete.paragraphs');
