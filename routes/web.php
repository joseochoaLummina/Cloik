...
Route::get('login/recruiter/{provider}', 'Recruiter\Auth\LoginController@redirectToProvider');
Route::get('login/recruiter/{provider}/callback', 'Recruiter\Auth\LoginController@handleProviderCallback');
// Sociallite End
/* * ***************************** */
...
/* * ******** ShareUrlController ************ */
include_once($real_path . 'share_url.php');
/* * ******** video apply ************ */
include_once($real_path . 'video_apply.php');
/* * ******** language test ************ */
include_once($real_path . 'language_test.php');
/* * ******** language test ************ */
include_once($real_path . 'meetings.php');
/* * ******** Message Center ************ */
include_once($real_path . 'messages.php');
/* * ******** RecruiterController ************ */
