                ...
                <div class="jobint">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <h4><a href="{{route('job.detail', [$featuredJob->slug])}}" title="{{$featuredJob->title}}">{{str_limit($featuredJob->title,50)}}</a></h4>
                            <div class="company"><a href="{{route('company.detail', $company->slug)}}" title="{{$company->name}}">{{str_limit($company->name,40)}}</a></div>
                            <div class="jobloc">
                                <label class="fulltime" title="{{$featuredJob->getJobType('job_type')}}">{{$featuredJob->getJobType('job_type')}}</label> <br> <span>{{$featuredJob->getCity('city')}}</span></div>
                        </div>
