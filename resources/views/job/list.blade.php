                    ...
                    <div class="col-md-9">
                        <div class="searchform">
                            <div class="row">
                                ...
                                <div class="col-md-4"> {!! Form::select('functional_area_id[]', ['' => __('Select Functional Area')]+$functionalAreas, Request::get('functional_area_id', null), array('class'=>'form-control', 'id'=>'functional_area_id')) !!} </div>
                    ...
                    <ul class="searchList">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-2" >
                                    @if ($job->confidential)
                                        <div class="jobimg"><img src="{{ asset('/') }}sitesetting_images/img_confidential_company.jpeg" alt="img_confidential_company"></div>
                                    @else
                                ...
                                <div class="col-md-8 col-sm-9">
                                    ...
                                    <div class="row w-100">
                                        ...
                                        @else
                                            <div class="companyName w-100"><a href="{{route('company.detail', $company->slug)}}" title="{{$company->name}}">{{$company->name}}</a></div>
                                        @endif
                                ...
                                <div class="col-md-2 col-sm-5 float-right">
                                    <div class="listbtn"><a href="{{route('job.detail', [$job->slug])}}">{{__('View Details')}}</a></div>
                                    <div class="listbtn"><a href="{{route('job.detail', [$job->slug])}}">{{__('favoritos')}}</a></div>
                                </div>
                            </div>
                            {{--<p>{{str_limit(strip_tags($job->description), 120, '...')}}</p>--}}
                        </li>
                        <!-- job end --> 
                        @endif
                        @endforeach
