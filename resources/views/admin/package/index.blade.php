                                ...
                                <table class="table table-striped table-bordered table-hover"  id="packageDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control" name="package_limit_master_recruiter" id="package_limit_master_recruiter" autocomplete="off" placeholder="limit master recruiters"></td>
                                            <td><input type="text" class="form-control" name="package_limit_jr_recruiter" id="package_limit_jr_recruiter" autocomplete="off" placeholder="limit jr recruiters"></td>
                                            <td><input type="text" class="form-control" name="is_custom" id="is_custom" autocomplete="off" placeholder="custom"></td>
                                        ...
                                        <tr role="row" class="heading">
                                            ...
                                            <th>Num Days</th>
                                            <th>Num Listings</th>
                                            <th>Limit Master Recruiter</th>
                                            <th>Limit Jr Recruiter</th>
                                            <th>Custom</th>
                                            <th>For</th>                                            
                                            <th>Actions</th>
                                        </tr>
        ...
        var oTable = $('#packageDatatableAjax').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.recruiters_master_limit = $('#recruiters_master_limit').val();
                    d.recruiters_jr_limit = $('#recruiters_jr_limit').val();                    
                    d.is_custom = $('#is_custom').val();
                ...
                {data: 'recruiters_master_limit', name: 'recruiters_master_limit'},
                {data: 'recruiters_jr_limit', name: 'recruiters_jr_limit'},
                {data: 'is_custom', name: 'is_custom'},
