...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'recruiters_master_limit') !!}"> {!! Form::label('recruiters_master_limit', 'Package limit master recruiters', ['class' => 'bold']) !!}
        {!! Form::number('recruiters_master_limit', null, array('class'=>'form-control', 'id'=>'recruiters_master_limit', 'placeholder'=>'Package limit master recruiters')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'recruiters_master_limit') !!} 
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'recruiters_jr_limit') !!}"> {!! Form::label('recruiters_jr_limit', 'Package limit Jr recruiter', ['class' => 'bold']) !!}
        {!! Form::number('recruiters_jr_limit', null, array('class'=>'form-control', 'id'=>'recruiters_jr_limit', 'placeholder'=>'Package limit Jr recruiters')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'recruiters_jr_limit') !!} 
        *On how many jobs a job seeker can apply<br />
        **How many jobs an employer can post </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_custom') !!}">
        <div class="radio-list">
            <label class="radio-inline">
                <input id="is_custom" name="is_custom" type="checkbox">
                Is custom?
            </label>
        </div>
