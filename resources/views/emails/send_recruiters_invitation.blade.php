      ...
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div
                      ...
                      <table id="u_content_image_1" class="u_content_image"
                        style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0"
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{asset('/')}}assets/email/cloik_logo.jpg" alt="Image" title="Image"
                                      style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 150px;"
                                      width="150" />
          ...
          <div class="email-row-container" style="padding: 0px 10px;background-color: rgba(255,255,255,0)">
            <div
              style="Margin: 0 auto;min-width: 320px;max-width: 650px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #454545;"
              class="email-row">
              <div
                style="border-collapse: collapse;display: table;width: 100%;background-image: url('./images/rect.png');background-repeat: repeat;background-position: center top;background-color: #454545;">
                    ...
                    <div
                      ...
                      <table id="u_content_text_1" class="u_content_text"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:50px 20px 20px;font-family:arial,helvetica,sans-serif;"
                              align="left">

                              <div
                                style="color: #29ffd8; line-height: 120%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 120%;"><span
                                    style="font-family: Montserrat, sans-serif; font-size: 40px; line-height: 48px;"><span
                                      style="line-height: 48px; font-size: large;">Invitation to complete registration
                                      process</span></span></p>
                              </div>
                      ...
                      <table id="u_content_image_2" class="u_content_image"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:15px 20px 20px;font-family:arial,helvetica,sans-serif;"
                              align="left">
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{asset('/')}}company_logos/{{$logo}}" alt="Image" title="Image"
                                      style="border-radius: 50%; outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 200px;"
                                      width="200" />
                      ...
                      <table id="u_content_text_2" class="u_content_text"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 35px;font-family:arial,helvetica,sans-serif;"
                              align="left">

                              <div
                                style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 18px; line-height: 25.2px;">Fill out the form with your personal
                                    data and complete the registration process
                                </p>
                              </div>
                    ...
                    <div
                      ...
                      <table id="u_content_text_3" class="u_content_text"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:40px 20px 10px;font-family:arial,helvetica,sans-serif;"
                              align="left">

                              <div style="color: #000; line-height: 150%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 150%;"><span
                                    style="font-size: 20px; line-height: 30px;"><br><br>
                                    <strong>Hello</strong>, the company {{$companyName}} has invited you to complete your profile to become part of their <strong>team of recruiters</strong> within our platform.<br><br>
                                  </span>
                                </p>
                              </div>
                      ...
                      <table id="u_content_divider_1" class="u_content_divider"
                        style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0"
                        cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <div
                                style="color: #07a88b; line-height: 150%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 150%;"><strong><span
                                      style="font-size: 30px; line-height: 45px;">Fill your registration</span></strong></p>
                              </div>
                      ...
                      <table id="u_content_button_1" class="u_content_button"
                        ...
                        <tbody>
                          <tr>
                            <td
                              style="overflow-wrap:break-word;word-break:break-word;padding:20px 20px 50px;font-family:arial,helvetica,sans-serif;"
                              align="left">
                              ...
                              <div align="center">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:arial,helvetica,sans-serif;"><tr><td style="font-family:arial,helvetica,sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:85px; v-text-anchor:middle; width:306px;" arcsize="59%" stroke="f" fillcolor="#28e0bf"><w:anchorlock/><center style="color:#FFF;font-family:arial,helvetica,sans-serif;"><![endif]-->
                                  ...
                                  <a href="http://www.cloik.com/invitations-recruiters/{{$invitationRecluterId}}" style="display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;
                                  text-align: center;color: #FFF; background-color: #28e0bf; border-radius: 50px; -webkit-border-radius: 50px; border: 0; cursor: pointer;
                                   -moz-border-radius: 50px; width: auto; padding: 0px 30px; mso-border-alt: none; cursor: pointer;"><span style="line-height:150%;"><strong><span
                                          style="font-size: 30px; line-height: 45px;">HERE</span></strong></span></a>
                          ...
                          <tr>
                            <td
                              ...
                              <div style="color: #999999; line-height: 120%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 120%; text-align: center;">If you consider that this message has been sent to you in a wrong way, please ignore it or help us by reporting the error.</p>
                                <p style="font-size: 14px; line-height: 120%; text-align: center;">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 120%; text-align: center;"><a target="_blank" href="https://www.cloik.com/report-recruiter-invitation-error/{{$invitationRecluterId}}">Clik here</a></p>
                              </div>
