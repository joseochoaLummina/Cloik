...
<div class="row row-foto-perfil">
    <div class="col-md-4 foto-perfil">
        <h5>{{__('Profile Image')}}</h5>
        <div class="foto-round"> {{ ImgUploader::print_image("user_images/$user->image", 100, 100) }} </div>
        <div class="formrow">
...
<div class="row info-profile">
    ...
    <div class="col-md-6">
        <h6>{{__('Surnames')}}</h6>
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'last_name') !!}"> {!! Form::text('last_name', null, array('class'=>'form-control', 'id'=>'last_name', 'placeholder'=>__('Surnames'))) !!}
            {!! APFrmErrHelp::showErrors($errors, 'last_name') !!}</div>
    </div>
    <!-- <div class="col-md-6">
        <h6>{{__('Father Name')}}</h6>
...
<div class="row info-profile">
    ...
    <div class="col-md-12">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'street_address') !!}"> {!! Form::textarea('street_address', null, array('class'=>'form-control', 'id'=>'street_address', 'placeholder'=>__('Write your address here'))) !!}
