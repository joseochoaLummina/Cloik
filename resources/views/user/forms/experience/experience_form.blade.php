<div class="modal-body">
    <div class="form-body">
        <div class="formrow" id="div_title">
            <span style="font-weight: bold;">{{__('Experience Title')}}</span>
        ...
        <div class="formrow" id="div_date_start">
            <span style="font-weight: bold;">{{__('Experience Start Date')}}</span>
        ...
        <div class="formrow" id="div_date_end">
            <span style="font-weight: bold;">{{__('Experience End Date')}}</span>
        ...
        <div class="formrow" id="div_is_currently_working">
            <label for="is_currently_working" class="bold" style="font-weight: bold;">{{__('Currently Working?')}}</label>
        ...
        <div class="formrow" id="div_description">
            <span style="font-weight: bold;">{{__('Experience description')}}</span>
