...
@else
{!! Form::model($company, array('method' => 'put', 'route' => array('recruiter.update.company.profile'), 'class' => 'form', 'files'=>true)) !!}
@endif  --}}
{!! Form::model($company, array('method' => 'put', 'route' => array('update.company.profile'), 'class' => 'form', 'files'=>true)) !!}
