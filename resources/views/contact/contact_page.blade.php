...
@php
    if (Auth::check() && Auth::user()) {
        if($completa){
            ...
            $page_title='includes.inner_page_title';
        }else {
            $header='includes.header_verifi';
            $page_title='includes.inner_page_title_profile';
        }
    }
    else {
        $header='includes.header';
...
@include($page_title, ['page_title'=>__('Contact Us')])
