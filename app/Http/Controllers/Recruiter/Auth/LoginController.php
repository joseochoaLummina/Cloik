...
use AuthenticatesUsers;
    ...
    {
        return view('recruiter_auth.login');
    }
    ...
    public function redirectToProvider($provider)
    {
        ...
        config(["services.{$provider}.redirect" => url("login/recruiter/{$provider}/callback")]);
    ...
    public function handleProviderCallback($provider)
    {
        ...
        Auth::guard('recruiter')->login($authUser, true);
    ...
    {
        /**Aqui hay que hacer que Recuiter si funcione para busquedas */

        if ($user->getEmail() != '') {
            $authUser = Recruiter::where('email', 'like', $user->getEmail())->first();
            if ($authUser) {
                // dd($authUser);
