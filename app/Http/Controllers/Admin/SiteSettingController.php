...
class SiteSettingController extends Controller
{
    ...
    public function editSiteSetting()
    {
        ...
        $recommendations=DB::select('SELECT recomendations FROM forge.site_settings');
        $mail_drivers = [
            'smtp' => 'SMTP',
            'mail' => 'Mail',
            'sendmail' => 'SendMail',
    ...
    public function updateSiteSetting(SiteSettingFormRequest $request)
    {
        ...
        $siteSetting->update();
        DB::update('update site_settings set recomendations =:recomendations', ['recomendations'=>$recomendations]);
